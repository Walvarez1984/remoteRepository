...
<div id="colores1" class="popup" style="visibility:${visible};"> 
	<div id="center" style="position:absolute;top:205px;left:201px;">
				...
				<td background="images/barralogin.gif" height="10px" align="right">
					<table border="0" width="100%" align="center" cellspacing="0" cellpadding="0"  class="tabla_informacion_encabezado">
						<tr>
							<td align="right">
								<div id="botonWin">
									<a href="#" class="linkBlanco8" onclick="requestAjax('calendarizacion.do?cerrarPaleta=ok', ['colores'], {popWait:false});ocultarModal();">X</a>
								</div>
							</td>
						</tr>	
					</table>
													...
													<c:if test="${filas1*4+columnas1 < tamano}">
														...
														<td width="2%">
															...
															<table bgcolor="${colorPlantilla}" border="0" class="tabla_informacion" cellpadding="0" cellspacing="0">
																<tr>
																	<td>
																		<html:link styleClass="paleta" title="${nombreColorPrincipal}" href="#" onclick="requestAjax('calendarizacion.do', ['colores','color','colorSeleccionado'], {parameters: 'indicecolor=${filas1*4+columnas1}',popWait:false});ocultarModal();">
																		</html:link>
																	</td>
																</tr>
															</table>
