...
<div id="detallesPlantillaCalendario">
								...
								<table border="0" class="textos" width="100%" align="center" cellspacing="0" cellpadding="0">
											...
											<table border="0" width="98%" align="center" cellspacing="0" cellpadding="0"  class="tabla_informacion">
												<tr>																						
													<logic:notEmpty name="ec.com.smx.calendarizacion.calendarioloc">
														...
														<td width="48%" align="center" class="tituloTablas columna_contenido"><B>CPE</B></td></logic:notEmpty>
													<logic:notEmpty name="ec.com.smx.calendarizacion.calendariobod">
														...
														<td width="21%" align="center" class="tituloTablas columna_contenido"><B>Camiones</B></td>																												<td width="21%" align="center" class="tituloTablas columna_contenido"><B>Num. Camiones</B></td>														
													</logic:notEmpty>																														
												</tr>	
											</table>
										</td>
									...
									<tr>
										<td  width="100%" align="center">
											<logic:notEmpty name="ec.com.smx.calendarizacion.calendariobod">
												<div id="divlistado2" style="width:98%;height:70px;overflow-x:hidden;overflow-y: auto;">						
															...
															<logic:iterate name="ec.com.smx.calendarizacion.calendarioDetPlaLocHorCamDTOCol" id="calendarioDetPlaLocHorComDTO" indexId="numeroDetalle">
																...
																<logic:notEqual name="calendarioDetPlaLocHorComDTO" property="calendarioDetallePlantillaLocalDTO.npEstadoDetalle" value="${estAnuladoPlantilla}">
																	...
																	<tr class="${color}">
																		...
																		<logic:notEmpty name="ec.com.smx.calendarizacion.calendariobod">
																		<td width="21%" class="textoNegro9" align="center">&nbsp;
																		...
																		<td width="21%" align="center" class="textoNegro10">
											...
											<logic:notEmpty name="ec.com.smx.calendarizacion.calendarioloc">
												<div id="div_listado" style="width:98%;height:70px;overflow-x:hidden;overflow-y: auto;">						
													<table class="tabla_informacion" border="0" cellpadding="1" cellspacing="1" width="100%" align="center">
