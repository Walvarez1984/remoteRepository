...
<html:form action="calendarizacion" method="post">
								...
								<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">								
									<tr>	
										...
										<td align="right" width="105px">
											<div id="botonD">
												<html:link styleClass="agregarD" href="#" onclick="requestAjax('calendarizacion.do', ['pregunta','mensajes'], {parameters: 'abrirConfiguracion=ok',popWait:true,evalScripts:true});ocultarScroll();">Agregar</html:link>						
											</div>
										</td>									
									</tr>
								</table>
	...
	<table border="0" cellspacing="0" cellpadding="0" class="textoNegro11" width="100%" align="center">	
		...
		<tr>
			<td id="pregunta">									
				<logic:notEmpty name="ec.com.smx.calendarizacion.mostrarpopup">
					<script language="javascript">
						$j(document).ready(function(){
							mostrarModal();
						});
					</script>
					<tiles:insert page="/calendarizacion/nuevaCalendarizacion/nuevaPlantilla.jsp"/>
					
					<tiles:insert page="/calendarizacion/nuevaCalendarizacion/paleta.jsp"/>					
				</logic:notEmpty>															
			</td>
		</tr>
				...
				<table border="0" cellspacing="0" cellpadding="0" class="textoNegro11" width="98%" align="center">
					...
					<tr>
						<td colspan="3" id="confirmar">
							<tiles:insert page="/calendarizacion/nuevaCalendarizacion/mensajesConfirmacion.jsp"/>
						</td>
					</tr>
					<tr>
						<%--Barra Izquierda--%>
						<td class="datos" width="260px">
							<table cellpadding="0" cellspacing="0">
								<tr>
									<td>
										<tiles:insert page="/calendarizacion/nuevaCalendarizacion/plantillas.jsp"/>
									</td>
								</tr>
						...
						<TD class="datos">
							<div id="actualizaCalendario">
								<tiles:insert page="/calendarizacion/nuevaCalendarizacion/calendario.jsp"/>
							</div>
						</TD>
					</tr>
				</table>
