        ...
        <div class="panelContent" style="width:99%">
                                                                ...
                                                                <logic:iterate name="ec.com.smx.calendarizacion.calendarioPlantillaLocalDTOCol" id="calendarioPlantillaLocalDTO" indexId="indicePlantilla">
                                                                    ...
                                                                    <tr class="${color}">
                                                                        ...
                                                                        <td width="15%" align="center">
                                                                            <html:link title="Editar" href="#" onclick="requestAjax('calendarizacion.do', ['plantillas','mensajes','pregunta'], {parameters: 'modificarPlantillaLink=${indicePlantilla}',popWait:true});mostrarModal();ocultarScroll();">
                                                                                <img src = "./images/editar16.gif" border="0" align="middle"/>
                                                                            </html:link>&nbsp;&nbsp;&nbsp;
                                                                        </td>
                                                                        <td width="15%" align="center">	
                                                                            <html:link title="Eliminar" href="#" onclick="requestAjax('calendarizacion.do', ['confirmar','plantillas','mensajes','mensajesPopUp'], {parameters: 'eliminarPlantillaLink=${indicePlantilla}',popWait:true, evalScripts:true});">
            ...
            <table width="100%" border="0">							
                <tr>
                    <td>				    	
                        <div id="plantillas">
                            <tiles:insert page="/calendarizacion/nuevaCalendarizacion/detallePlantilla.jsp"/>
                        </div>
                    </td>
                </tr>
            </table>            
