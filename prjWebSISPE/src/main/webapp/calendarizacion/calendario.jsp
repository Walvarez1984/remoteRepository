				...
				<table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
					<tr>
						...
						<td width="7%" align="right">
							<html:link title="Mes Anterior" href="#" onclick="requestAjax('calendarizacion.do', ['cambioMes','calendario','mensajes'], {parameters: 'mesAnterior=ok',popWait:true});">
						...
						<td width="5%">
							<html:link title="Mes Siguiente" href="#" onclick="requestAjax('calendarizacion.do', ['cambioMes','calendario','mensajes'], {parameters: 'mesSiguiente=ok',popWait:true});">
