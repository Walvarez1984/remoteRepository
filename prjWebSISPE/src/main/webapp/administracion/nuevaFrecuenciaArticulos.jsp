...
<html:form action="nuevaFrecuenciaArticulos" method="post">
            ...
            <td align="left" valign="top" width="100%">
                <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" class="titulosAccion">
                    <tr>
                        ...
                        <td height="35" valign="middle">Nueva Frecuencia Art&iacute;culos</td>
                            ...
                            <table border="0">
                                <tr>
                                    <td>
                                        ...
                                        <div id="botonA">
                                            <html:link href="#" styleClass="guardarA" onclick="realizarEnvio('guardarFrecuencia')" title= "Guardar la nueva frecuencia">
                                                Guardar
                                            </html:link>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div id="botonA">
                                            <html:link action="frecuenciaArticulos" styleClass="cancelarA" title= "Cancelar la creaci&oacute;n de la nueva frecuencia">Cancelar</html:link>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                                            <tr>
                                                <td align="left" class="textoAzul11N">C&oacute;digo de Art&iacute;culo:&nbsp;</td>
                                                <td>
                                                <input style="display:none;" type="text" name="oculto">
                                                <html:text property="codigoArticulo" size="30" onkeydown="realizarEnvioEnter('agregarArticulo')" styleClass="textNormal" /> 
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>
                                                    <div id="botonD">
                                                        <html:link styleClass="agregarD" href="#"
                                                                   onclick="realizarEnvio('agregarArticulo')" title="Agregar un art&iacute;culo a la frecuencia">
                                                            Agregar
                                                        </html:link>
                                                    </div>                                                    
                                                </td>
                                                ...
                                                <logic:iterate name="ec.com.smx.sic.sispe.administracion.frecuenciaArticulos" id="frecuenciaArticulosCol" indexId="indiceRegistro">
                                                    ...
                                                    <logic:notEmpty name="frecuenciaArticulosCol" property="estadoFrecuenciaArticulo">
                                                        <tr class="${colorBack}" >
                                                            ...
                                                            <td align="center" class="columna_contenido fila_contenido columna_contenido_der" width="17%">
                                                                <table border="0" align="center">
                                                                    <tr>
                                                                        ...
                                                                        <td align="center">
                                                                        	<html:link  href="#" onclick="requestAjax('nuevaFrecuenciaArticulos.do',['mensajes','div_listado'],{parameters: 'indiceEliminacion=${indiceRegistro}'});">
                                                                                Eliminar
                                                                            </html:link>
                                                                        </td>
                                                                    </tr>
