...
<%-- ---------- INICIO - Formulario de Nuevo especial ---------- --%>
<html:form action="nuevoEspecial" method="post">
    <TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tr>
            <td align="left" valign="top" width="100%">
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" class="titulosAccion">
                    <tr>
                        <td  width="3%" align="center"><img src="./images/nuevosEspeciales.gif" border="0"></td>
                        <td height="35" valign="middle">Nuevo Especial</td>
                        <td align="right" valign="top">
                            <table border="0">
                                <tr>
                                    <td>
                                        <div id="botonA">
                                            <html:link href="#" styleClass="guardarA" onclick="realizarEnvio('registrarEspecial')">
                                                Guardar
                                            </html:link>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div id="botonA">
                                            <html:link action="nuevoEspecial" paramId="volver" paramName="atras" styleClass="cancelarA">
                                                Cancelar
                                            </html:link>
                                        </div>
                                    </td>
        ...
        <tr>
            <td valign="top">
                <table border="0" width="98%" cellpadding="2" cellspacing="0" class="tabla_informacion" align="center">
                    <tr>
                    ...
                    <tr>
                        <td class="textoAzul11" align="right" width="10%">Descripci&oacute;n:*</td>
                        <td align="left">
                            <smx:text name="especialForm" property="descripcionEspecial" styleClass="textObligatorio" styleError="campoError" maxlength="100" size="40"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="fila_titulo" colspan="3">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" class="textoNegro11">
                                <tr>
                                    <td>&nbsp;</td>
                                    <td height="23" width="63%">&nbsp;Lista de Clasificaciones </td>
                                    <td>
                                        <table cellpadding="1" cellspacing="0" border="0" width="100%">
                                            <tr>
                                                ...
                                                <td>
                                                    <html:text property="codigoClasificacionEspecial" size="10" styleClass="textNormal" onkeyup="requestAjaxEnter('nuevoEspecial.do',['mensajes','div_listado'],{parameters: 'botonAgregarClasificacion=ok', evalScripts: true});"/>
                                                </td>
                                                <td>&nbsp;</td>
                                                <td>
                                                    <div id="botonD">
                                                        <html:link styleClass="agregarD" href="#" onclick="requestAjax('nuevoEspecial.do',['mensajes','div_listado'],{parameters: 'botonAgregarClasificacion=ok', evalScripts: true});">Agregar</html:link>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div id="botonD">
                                                        <html:link styleClass="buscarD" href="#" onclick="dialogoWeb('catalogoArticulos.do','WIN_RBUS','dialogHeight:650px;dialogWidth:900px;help:no;scroll:no');requestAjax('nuevoEspecial.do',['mensajes','div_listado'],{parameters: 'agregarClasificaciones=ok', evalScripts: true});">Buscar</html:link>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                        ...
                                        <logic:iterate name="ec.com.smx.sic.sispe.especialesClasificaciones" id="especialClasificacionDTO" indexId="numeroRegistro">	
                                            ...
                                            <tr class="${colorBack}">
                                                ...
                                                <td align="center" class="columna_contenido fila_contenido columna_contenido_der" width="20%" id="accion_${numeroRegistro}">
                                                    <logic:equal name="especialClasificacionDTO" property="estadoEspecialClasificacion" value="${estadoActivo}">
                                                        <html:link href="#" onclick="requestAjax('nuevoEspecial.do',['estado_${numeroRegistro}','accion_${numeroRegistro}'], {parameters: 'indiceDesactivacionActivacion=${numeroRegistro}'});">
                                                            Desactivar
                                                        </html:link>
                                                    </logic:equal>
                                                    <logic:notEqual name="especialClasificacionDTO" property="estadoEspecialClasificacion" value="${estadoActivo}">
                                                    ...
                                                    <html:link href="#" onclick="requestAjax('nuevoEspecial.do',['div_listado'], {parameters: 'indiceEliminacion=${numeroRegistro}'});">
                                                        Eliminar
                                                    </html:link>
                                                </td>
                                            </tr>	
...
<%-- ---------- FIN - Formulario de Nuevo Especial ------------%>
