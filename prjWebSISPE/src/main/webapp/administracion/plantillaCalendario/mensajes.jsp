                            ...
                            <td class="textoNegro11" align="center">
                                <table border="0" width="99%">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <div id="botonDmin">
                                                <html:link styleClass="siDmin" href="#" onclick="requestAjax('adminPlantillas.do', ['listadoPlantilla','confirmar','plantillas','actualizaCalendario','mensajes'], {parameters: 'condicionSi=ok',popWait:true});ocultarModal();">Si</html:link>
                                            </div>	
                                        </td>
                                        <td align="center">
                                            <div id="botonDmin">
