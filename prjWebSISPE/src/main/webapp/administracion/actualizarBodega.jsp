...
<html:form action="/actualizarBodega" method="post">
        ...
        <tr>
            <td align="left" valign="top" width="100%">
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" class="titulosAccion">
                    <tr>
                        <td width="3%" align="center"><img src="./images/editarBodegas.gif" border="0"></td>
                        <td height="35" valign="middle">Actualizar Bodega</td>
                        <td align="right" valign="top">
                            <table border="0">
                                <tr>
                                    <td>
                                        <div id="botonA">
                                            <html:link href="#" styleClass="guardarA" onclick="realizarEnvio('guardarBodega')" title="Guardar bodega">
                                                Guardar
                                            </html:link>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <div id="botonA">
                                            <html:link action="bodegas.do" styleClass="cancelarA" title="Cancelar la edici&oacute;n de la bodega">Cancelar</html:link>
                                        </div>
                                    </td>
	                            	<td>
        ...
        <tr>
            <td align="center" valign="top">
                <table border="0" width="98%" cellpadding="2" cellspacing="0" class="tabla_informacion">
                    ...
                    <tr>
                        <td class="textoAzul11N" align="right">Descripci&oacute;n Bodega:*</td>
                        <td align="left">
