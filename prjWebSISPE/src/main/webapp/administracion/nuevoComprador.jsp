...
<html:form action="/nuevoComprador" method="post">
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" class="titulosAccion">
                    <tr>
                        <td width="3%" align="center">
                            <img src="./images/nuevoComprador.gif" border="0">
                        </td>
                        <td height="35" valign="middle">Nuevo Comprador</td>
        ...
        <tr>
            <td align="center" valign="top">
                ...
                <table border="0" width="98%" cellpadding="2" cellspacing="0" class="tabla_informacion">
                    ...
                    <tr>
                        <td class="textoAzul11N" align="right" width="15%">Estado:*</td>
                        <td align="left">
                    ...
                    <tr>
                        <td class="textoAzul11N" align="right" width="15%">Tipo Comprador:*</td>
                        <td align="left">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <smx:text property="nombreComprador" styleClass="textObligatorio" styleError="campoError" size="100" maxlength="100"/>
                        </td>
                    </tr>
                    <tr>
