...
<table border="0" width="100%" align="center" cellspacing="0" cellpadding="0" class="textoNegro11">
    <html:form action="actualizarClasificacionUsuario" method="post">
        <tr>
            <td align="left" valign="top" width="100%">
                <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" class="titulosAccion">
                    ...
                    <tr>
                        <td  width="3%" align="center"><img src="./images/editarPermisoClasificacion.gif" border="0"></td>
                        <td height="35" valign="middle">Modificar Configuraci&oacute;n de Permisos</td>
                        <td align="right" valign="top">
                            <table border="0">
                                <tr>
                                    <td>
                                        <div id="botonA">
                                            <html:link href="#" styleClass="guardarA" onclick="realizarEnvio('guardarA');">Guardar</html:link>
                                        </div>
                                    </td>
                                    <td>
                                        <div id="botonA">	
        ...
        <tr>
            <td>
                <table cellpadding="2" cellspacing="0" width="98%" class="tabla_informacion" align="center">
                    ...
                    <tr>
                        <td align="right" class="textoAzul11" width="13%">Id Usuario:</td>
                        <td align="left"><html:hidden property="idUsuario" write="true"/></td>
                    </tr>
                    <tr>
                        <td align="right" class="textoAzul11">Nombre:</td>
                        <td align="left"><html:hidden property="nombreUsuario" write="true"/></td>
                    </tr>
                    <tr>
                        <td align="right" class="textoAzul11">Nombre Completo:</td>
                        <td align="left"><html:hidden property="nombreCompletoUsuario" write="true"/></td>
                    </tr>                  
                </table>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" width="98%" align="center">
                                        ...
                                        <table cellpadding="1" cellspacing="0" align="right" width="100%">
                                            <tr>
                                                ...
                                                <td align="right" width="10%">
                                                    <div id="botonD">
                                                        <html:link styleClass="agregarD" href="#" onclick="requestAjax('actualizarClasificacionUsuario.do', ['mensajes','text_clasificacion','listado_general'], {parameters: 'agregarClasificacion=ok', evalScripts:true});">Agregar</html:link>
                                                    </div>
                                                </td>
                                                <td align="right" width="10%">
                                                    <div id="botonD">
                                                        <html:link styleClass="buscarD" href="#" title="buscar clasificaciones" onclick="dialogoWeb('catalogoArticulos.do','WIN_RBUS','dialogHeight:650px;dialogWidth:900px;help:no;scroll:no');requestAjax('actualizarClasificacionUsuario.do', ['mensajes','listado_general'], {parameters: 'agregarClasificaciones=ok', evalScripts:true});">Buscar</html:link>
                                                    </div>
                                                </td>
                                                <td align="right" width="10%">
                                                    <div id="botonD">
                                                        <html:link styleClass="eliminarD" href="#" title="eliminar clasificacion" onclick="requestAjax('actualizarClasificacionUsuario.do', ['mensajes','listado_general'], {parameters: 'eliminarClasificacion=ok'});">Eliminar</html:link>
                                                    </div>
                                                </td>
                                                <td align="right" width="10%">
                                                    <div id="botonD">
                                                        <html:link styleClass="actualizarD" href="#" title="activar/desactivar clasificacion" onclick="requestAjax('actualizarClasificacionUsuario.do', ['mensajes','listado_general'], {parameters: 'activarDesactivarClasificacion=ok'});">Act/Des</html:link>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                    ...
                    <tr>
                        <td class="columna_contenido fila_contenido columna_contenido_der" valign="top">
                                            ...
                                            <td>
                                                <table border="0" cellpadding="1" cellspacing="0" width="98%" align="center">
                                                    <tr class="tituloTablas" align="center">
                                                        ...
                                                        <td width="10%" class="columna_contenido" align="center">C&Oacute;DIGO</td>
                                                        <td width="75%" class="columna_contenido" align="center">DESCRIPCI&Oacute;N</td>
                                                        <td width="10%" class="columna_contenido" align="center">ESTADO</td>
                                                        <%--<td width="20%" class="columna_contenido columna_contenido_der" align="center">ACCION</td>--%>
                                                    </tr>
                                                </table>
                                            </td>
                                        </tr>
                                                            ...
                                                            <logic:notEmpty name="clasificacionUsuarioDTO" property="estadoClasificacionUsuario">
                                                                <tr class="${clase}">
                                                                    ...
                                                                    <%--<td align="center" width="20%" class="columna_contenido fila_contenido columna_contenido_der" id="col_accion_${indiceRegistro}">
                                                                        ...
                                                                        <html:link href="#" onclick="requestAjax('actualizarClasificacionUsuario.do',['detalle_clasificaciones'],{parameters: 'indiceE=${indiceRegistro}'});">Eliminar</html:link>&nbsp;/&nbsp;<html:link href="#" onclick="requestAjax('actualizarClasificacionUsuario.do',['col_est_${indiceRegistro}','col_accion_${indiceRegistro}'],{parameters: 'indiceAD=${indiceRegistro}'});">${accion}</html:link>
                                                                    </td>--%>
                                                                </tr>
