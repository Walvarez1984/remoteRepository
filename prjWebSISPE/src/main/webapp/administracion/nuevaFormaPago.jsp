...
<html:form action="nuevaFormaPago" method="post">
        ...
        <tr>
            <td align="left" valign="top" width="100%">
                ...
                <table border="0" width="100%" cellspacing="0" cellpadding="0" align="center" class="titulosAccion">
                    <tr>
                        <td width="3%" align="center"><img src="./images/nuevaFormaPago.gif" border="0"></td>
                        <td height="35" valign="middle">Nueva Forma Pago</td>
