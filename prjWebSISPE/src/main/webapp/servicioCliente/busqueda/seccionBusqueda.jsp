...
<bean:define id="accionRecRes"><bean:message key="ec.com.smx.sic.sispe.accion.recotizarReservar"/></bean:define>
<bean:define id="accionContProduccion"><bean:message key="ec.com.smx.sic.sispe.accion.pendienteProduccion"/></bean:define>
<bean:define id="accionActProduccion"><bean:message key="ec.com.smx.sic.sispe.accion.actualizarProduccion"/></bean:define>
<bean:define id="accionConfRes"><bean:message key="ec.com.smx.sic.sispe.accion.confirmarReservacion"/></bean:define>
<bean:define id="accionAnulacionPedido"><bean:message key="ec.com.smx.sic.sispe.accion.anulacion"/></bean:define>
<bean:define id="accionEntrega"><bean:message key="ec.com.smx.sic.sispe.accion.entrega"/></bean:define>
<bean:define id="accionDespacho"><bean:message key="ec.com.smx.sic.sispe.accion.despacho"/></bean:define>
<bean:define id="accionDespachoEspecial"><bean:message key="ec.com.smx.sic.sispe.accion.despachoEspecial"/></bean:define>
<bean:define id="entidadResponsableLocal"><bean:message key="ec.com.smx.sic.sispe.entidadResponsable.local"/></bean:define>
<bean:define id="accionPedidoEspecial"><bean:message key="ec.com.smx.sic.sispe.accion.listaConfirmarPedidoEspecial"/></bean:define>
<bean:define id="accionControlProduccionEspecial"><bean:message key="ec.com.smx.sic.sispe.accion.listaControlProduccionPedEsp"/></bean:define>
<bean:define id="accionModificarReserva"><bean:message key="ec.com.smx.sic.sispe.accion.modificarReservacion"/></bean:define>
<bean:define id="accionArticulosReservados"><bean:message key="ec.com.smx.sic.sispe.accion.reporteArticulosReservados"/></bean:define>
<bean:define id="accionConsolidarPedido"><bean:message key="ec.com.smx.sic.sispe.accion.consolidarPedido"/></bean:define>
<bean:define id="accionEnvioOrdenCompraPerecibles"><bean:message key="ec.com.smx.sic.sispe.accion.envio.ordencompra.perecibles"/></bean:define>
<bean:define id="accionDesbloquearPOS"><bean:message key="ec.com.smx.sic.sispe.accion.desbloquearReservaPOS"/></bean:define>
...
<bean:define id="estadoInativo"><bean:write name="sispe.estado.inactivo"/></bean:define>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionEnvioOrdenCompraPerecibles}">
	<bean:define id="accion" value="enviarOCPerecibles.do"></bean:define>
	<bean:define id="altoDivLocCal" value="408px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionControlProduccionEspecial}">
	<bean:define id="accion" value="controlProduccionPedEsp.do"></bean:define>
	<bean:define id="mostrarReserva" value="mostrarReserva"></bean:define>
	<bean:define id="altoDivLocCal" value="330px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionPedidoEspecial}">
	<bean:define id="accion" value="confirmarPedidoEspecial.do"></bean:define>
	<bean:define id="mostrarReserva" value="mostrarReserva"></bean:define>
	<bean:define id="altoDivLocCal" value="430px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionEstadoPedido}">
	<bean:define id="idForm" value="listadoPedidosForm"/>
	<bean:define id="accion" value="estadoPedido.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionRecRes}">
	<bean:define id="idForm" value="listadoPedidosForm"/>
	<bean:define id="accion" value="recotizarReservar.do"/>
	<bean:define id="altoDivLocCal" value="440px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionContProduccion}">
	<bean:define id="idForm" value="controlProduccionForm"/>
	<bean:define id="accion" value="controlProduccion.do"/>
	<bean:define id="altoDivLocCal" value="350px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionActProduccion}">
	<bean:define id="accion" value="actualizarProduccion.do"/>
	<bean:define id="altoDivLocCal" value="385px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionConfRes}">
	<bean:define id="idForm" value="listadoPedidosForm"/>
	<bean:define id="accion" value="listaConfirmarReservacion.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionAnulacionPedido}">
	<bean:define id="idForm" value="anulacionesForm"/>
	<bean:define id="accion" value="anulacionPedido.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionEntrega}">
	<bean:define id="accion" value="entregaPedido.do"/>
	<bean:define id="altoDivLocCal" value="323px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionDespacho}">
	<bean:define id="accion" value="despachoPedido.do"/>
	<bean:define id="altoDivLocCal" value="340px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionDespachoEspecial}">
	<bean:define id="accion" value="despachoEspecial.do"/>
	<bean:define id="altoDivLocCal" value="340px"/>
</logic:equal>
<logic:equal name="ec.com.smx.sic.sispe.accion" value="${accionModificarReserva}">
	<bean:define id="idForm" value="listadoPedidosForm"/>
	<bean:define id="accion" value="listaModificarReserva.do"/>
	<bean:define id="altoDivLocCal" value="430px"/>
</logic:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.registrarAbonoPedido">
	<bean:define id="accion" value="registrarAbonoPedido.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.verAbonoPedido">
	<bean:define id="accion" value="reenviarModificarAbonos.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.registrarOrdenCompra">
	<bean:define id="accion" value="registrarOrdenCompra.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.enviarDespacho">
	<bean:define id="accion" value="actualizarDespacho.do"/>
	<bean:define id="altoDivLocCal" value="385px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.reporteEntregas">
	<bean:define id="accion" value="reporteEntregas.do"/>
	<bean:define id="altoDivLocCal" value="385px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.reporteArticulosReservados">
	<bean:define id="accion" value="reporteArticulosReservados.do"/>
	<bean:define id="altoDivLocCal" value="385px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.modificarFechasEntrega">
	<bean:define id="accion" value="listaModificarFechasEntrega.do"/>
	<bean:define id="altoDivLocCal" value="440px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.consolidarPedido">
	<bean:define id="accion" value="crearCotizacion.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</smx:equal>
<smx:equal name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.desbloquearReservaPOS">
	<bean:define id="accion" value="bloquearReservaPOS.do"/>
	<bean:define id="altoDivLocCal" value="435px"/>
</smx:equal>
					...
					<td>
						<div style="width:100%;height:${altoDivLocCal};overflow-y:auto;overflow-x:hidden;">
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
											...
											<table cellpadding="1" cellspacing="0">
												...
												<tr>
													<td class="textoAzul11" width="15%" colspan="2">
														&nbsp;Envio CD:&nbsp;<html:select property="comboEnviadoCD" styleClass="combos" onkeyup="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});">
															<html:option value="">Todos</html:option>
												...
												<tr>
													<td class="textoAzul11" width="15%" colspan="2">
														&nbsp;Tipo pedido:&nbsp;<html:select property="comboTipoPedido" styleClass="combos" onkeyup="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});">
															<html:option value="">Todos</html:option>
								...
								<c:if test="${accionDespacho == tipoAccion || accionActProduccion == tipoAccion || accionContProduccion == tipoAccion}">
									<tr>
										<td class="textoAzul11" width="15%" colspan="2">
											&nbsp;Responsabilidad:&nbsp;<html:select property="opEntidadResponsable" styleClass="combos">
												<html:option value="">Todos</html:option>
								...
								<logic:notEqual name="ec.com.smx.sic.sispe.accion" value="${accionEnvioOrdenCompraPerecibles}">
									...
									<script language="JavaScript">
											function ocultarSeccionFechas(){
												...
												document.getElementById("numRes").value!=""){
													plegar("Busqueda");
													//document.getElementById("opcionFecha").value = "hoy";	
													elemento = $j("#opcionFecha");
													elemento.val("hoy");
													//chequear(document.forms[0].opcionFecha[1]);													
									...
									<tr>
										...
										<td align="left" >
											<html:text styleId="numPed" property="numeroPedidoTxt" styleClass="textNormal" size="18" maxlength="100" onkeyup="ocultarSeccionFechas();requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});" onkeypress="return validarInputNumeric(event);" 
									...
									<logic:empty name="ec.com.smx.sic.sispe.accion.consolidar">
										<logic:notEqual name="${mostrarReserva}" value="mostrarReserva">
											<tr>
												...
												<td align="left" >
													<html:text styleId="numRes" property="numeroReservaTxt" styleClass="textNormal" size="18" maxlength="100" onkeyup="ocultarSeccionFechas();requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});" onkeypress="return validarInputNumeric(event);" 
													onkeydown="return checkKeysCombination(event,'ctrl,86') ? setPasteTime(this, 20, true, true, '99999999999999999999', '0'):true"/>
												</td>
											</tr>
											<!-- tr>
												...
												<td align="left" >
													<html:text property="numeroConsolidadoTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"/>
												</td>
											</tr-->
										</logic:notEqual>
									</logic:empty>
								...
								<logic:notEqual name="ec.com.smx.sic.sispe.accion" value="${accionConsolidarPedido}">
									<logic:notEqual name="ec.com.smx.sic.sispe.accion" value="${accionEntrega}">
										...
										<tr>
											...
											<td align="left" >
												<html:text property="codigoClasificacionTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="return validarInputNumeric(event);" onkeyup="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"
												onkeydown="return checkKeysCombination(event,'ctrl,86') ? setPasteTime(this, 20, true, true, '99999999999999999999', '0'):true"/>
											</td>
										</tr>
										<tr>
											...
											<td align="left" >
												<html:text property="codigoArticuloTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="return validarInputNumeric(event);" onkeyup="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"
												onkeydown="return checkKeysCombination(event,'ctrl,86') ? setPasteTime(this, 20, true, true, '99999999999999999999', '0'):true"/>
											</td>
										</tr>
										<tr>
											...
											<td align="left" >
												<html:text property="descripcionArticuloTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"/>
											</td>
										</tr>
										<tr><td height="5px"></td></tr>
									</logic:notEqual>
								...
								<tr>
									...
									<td align="left" >
										<html:text property="documentoPersonalTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"/>
									</td>
								</tr>
								<%--Nombre del contacto--%>
								<tr>
									...
									<td align="left" >
										<html:text property="nombreContactoTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"/>
									</td>
								</tr>
								<tr><td height="5px"></td></tr>
								<%-- Empresa--%>
								...
								<tr>
									...
									<td align="left" >
										<html:text property="rucEmpresaTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"/>
									</td>
								</tr>
								<%--Nombre del contacto--%>
								<tr>
									...
									<td align="left" >
										<html:text property="nombreEmpresaTxt" styleClass="textNormal" size="18" maxlength="100" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'})"/>
									</td>
								</tr>
								</logic:notEqual>
								<%--Estado del pedido--%>
								...
								<logic:notEmpty name="ec.com.smx.sic.sispe.estadosPago">
									...
									<tr>
										<td colspan="2">
											&nbsp;<html:select property="estadoPagoPedido" styleClass="combos" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});">
												<html:option value="">Todos</html:option>
										...
										<logic:notEmpty name="ec.com.smx.sic.sispe.tipoFechaBusqueda">
											<smx:notEqual name="ec.com.smx.sic.sispe.accion" valueKey="ec.com.smx.sic.sispe.accion.reporteEntregas">
												...
												<logic:notEmpty name="ec.com.smx.sic.sispe.accion.seccion.busqueda.reportes">
													...
													<tr>
														<td colspan="2">
															&nbsp;<html:select property="comboTipoFecha" styleClass="combos" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});">
									...
									<div id="marcoBusqueda">
										<logic:empty name="ec.com.smx.sic.sispe.mostrar.filtros.locales">
											<table border="0" width="100%" cellspacing="0" cellpadding="0">
																	...
																	<table border="0" cellspacing="0">
																		<tr>
																			<td class="textoAzul11">
																				<html:text styleId="fechaInicial" property="fechaInicial" styleClass="textNormal" size="12" maxlength="10" onfocus="document.forms[0].opcionFecha[0].checked=true;" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});return validarInputFecha(event);"/>
																			</td>
															...
															<tr>
																...
																<td>
																	<table border="0" cellspacing="0">
																		<tr>
																			<td class="textoAzul11">
																				<html:text styleId="fechaFinal" property="fechaFinal" styleClass="textNormal" size="12" maxlength="10" onfocus="document.forms[0].opcionFecha[0].checked=true;" onkeypress="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});return validarInputFecha(event);"/>
																			</td>
																			<td onclick="document.forms[0].opcionFecha[0].checked=true;">
												...
												<tr>
													<td><html:radio styleId="opcionFecha" property="opcionFecha" value="${opHoy}"/></td>
												...
												<tr>
													...
													<td align="left" class="textoAzul11" onclick="chequear(document.forms[0].opcionFecha[2]);">
														Desde&nbsp;<html:text property="numeroMeses" styleClass="textNormal" size="3" maxlength="3" onfocus="document.forms[0].opcionFecha[2].checked=true;" onkeypress="return validarInputNumeric(event);" onkeyup="requestAjaxEnter('${accion}', ['mensajes','seccion_autorizacion','resultadosBusqueda'], {parameters: 'buscar=ok'});"
		...
		<td colspan="2">
			<table cellpadding="1" cellspacing="0" width="100%">
				<tr>
					<td align="center">
						<div id="botonD">
							<html:link styleClass="buscarD" href="#" onclick="requestAjax('${accion}',['mensajes','seccion_autorizacion','resultadosBusqueda'],{parameters: 'buscar=ok'});">Buscar</html:link>
						</div>
					</td>
					<td width="3px"></td>
				</tr>
