                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                                <tr>
                                    ...
                                    <td width="85%" align="left">	
                                        <b>&nbsp;Lista de reservas despachadas:</b>
                                    </td>
                                    <logic:notEmpty name="despachosEntregasForm" property="datos">
                                    	<td width="10%" align="left">
                                            <div id="botonD">	
                                                <html:link styleClass="imprimirD" href="#" onclick="requestAjax('despachoEspecial.do',['mensajes','ventanaImpresion2'],{parameters: 'botonImprimir2=ok', evalScripts: true});">Ver Reporte</html:link>
                                            </div>												
                                        </td>
                                    	<%--<td width="10%" align="left">
                                            <div id="botonD">	
    ...
    <tr>
        <td id="ventanaImpresion2">
            <script language="JavaScript" type="text/javascript">
				verificarAbrirVentana('despachoEspecial.do?mostrarVentana2=ok','Despachos reservas','${parametroImpresion2}');
            </script>
        </td>
    </tr>
  </table>
