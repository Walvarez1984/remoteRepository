...
<table border="0" cellspacing="0" cellpadding="0" width="100%"  align="right">
											...
											<table border="0" cellspacing="0" cellpadding="0" width="100%">
												...
												<logic:iterate name="ec.com.smx.sic.sispe.vistaPedido" property="vistaDetallesDiferidos" id="extructuraDiferidos" indexId="indiceDif">
													...
													<tr  class="${colorBack}" valign="middle" height="30px">
														...
														<td  class="columna_contenido fila_contenido" width="11%" align="left"><bean:write name="extructuraDiferidos" property="vistaDetallePedidoDTO.articuloDTO.codigoBarrasActivo.id.codigoBarras"/></td>
														...
														<logic:notEmpty name="vistaDetallePedidoDTO.articuloDTO.articuloComercialDTO.marcaComercialArticulo">
															<bean:write name="extructuraDiferidos" property="vistaDetallePedidoDTO.articuloDTO.articuloComercialDTO.marcaComercialArticulo.nombre"/>,
														</logic:notEmpty>
														
														</td>
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.vistaDetallePedidoDTO.articuloDTO.PVP}"/></td>
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.vistaDetallePedidoDTO.articuloDTO.precioBaseNoAfiImp}"/></td>
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.vistaDetallePedidoDTO.articuloDTO.precioBaseImp}"/></td>
	...
	<tr>
		<td align="center">
			<div id="botonD">
				<html:link styleClass="cancelarD" action="detalleEstadoPedido.do?cancelarDiferido=ok">Cancelar</html:link>
			</div>
		</td>
	</tr>
