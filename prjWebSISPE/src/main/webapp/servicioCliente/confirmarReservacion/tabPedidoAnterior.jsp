					...
					<tr>
						<table cellspacing="0" cellpadding="0" width="98%" align="left">
							<tr class="tituloTablas">
								...
								<td width="10%" align="center" class="columna_contenido" rowspan="2">Cantidad</td>								
							</tr>
						</table>
					</tr>
					<tr>
						<td>
							<div id="div_listado" style="width: 100%; height: 200px; overflow: auto">
								<table cellspacing="0" cellpadding="1" width="98%" align="left" border="0">									
									<logic:iterate name="ec.com.smx.sic.sispe.detallePedidoClone" id="detalle" indexId="numeroRegistro">
