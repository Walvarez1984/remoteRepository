											...
											<table border="0" cellspacing="0" cellpadding="0" width="100%">
												...
												<logic:iterate name="ec.com.smx.sic.sispe.reporteDiferidos" id="extructuraDiferidos" indexId="indiceDif">
													...
													<tr  class="${colorBack}" valign="middle" height="30px">
														...
														<td  class="columna_contenido fila_contenido" width="11%" align="left"><bean:write name="extructuraDiferidos" property="detallePedidoDTO.articuloDTO.codigoBarras"/></td>
														...
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.detallePedidoDTO.articuloDTO.precioArticuloIVAProveedor}"/></td>
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.detallePedidoDTO.articuloDTO.precioArticuloIVANoAfiliado}"/></td>
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.detallePedidoDTO.articuloDTO.precioArticuloIVA}"/></td>
