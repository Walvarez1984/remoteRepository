...
<table border="0" cellspacing="0" cellpadding="0" width="100%"  align="right">
						...
						<td bgcolor="#ffffff">
							<table border="0" cellspacing="0" cellpadding="0" width="100%">
								<tr class="tituloTablas" height="15px">
									...
									<td align="center" width="8%">SUB-TOTAL</td>
								</tr>
								<tr>
											...
											<table border="0" cellspacing="0" cellpadding="0" width="100%">
												...
												<logic:iterate name="ec.com.smx.sic.sispe.vistaPedido" property="vistaDetallesDiferidos" id="extructuraDiferidos" indexId="indiceDif">
													...
													<tr  class="${colorBack}" valign="middle" height="30px">
														...
														<td  class="columna_contenido fila_contenido" width="11%" align="left"><bean:write name="extructuraDiferidos" property="vistaDetallePedidoDTO.articuloDTO.codigoBarras"/></td>
														<td  class="columna_contenido fila_contenido" width="30%" align="left"><bean:write name="extructuraDiferidos" property="vistaDetallePedidoDTO.articuloDTO.descripcionArticulo"/>,&nbsp;														
														...
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.vistaDetallePedidoDTO.articuloDTO.precioArticuloIVAProveedor}"/></td>
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.vistaDetallePedidoDTO.articuloDTO.precioArticuloIVANoAfiliado}"/></td>
														<td  class="columna_contenido fila_contenido" width="8%" align="right"><fmt:formatNumber type="number" pattern="${formatosNumeros}" value="${extructuraDiferidos.vistaDetallePedidoDTO.articuloDTO.precioArticuloIVA}"/></td>
														<td  class="columna_contenido fila_contenido" width="8%" align="center"><bean:write name="extructuraDiferidos" property="vistaDetallePedidoDTO.cantidadEstado"/></td>
														...
														<c:set var="subTotal" value="${extructuraDiferidos.vistaDetallePedidoDTO.cantidadEstado * extructuraDiferidos.vistaDetallePedidoDTO.articuloDTO.precioArticuloIVA}"/>
	...
	<tr>
		<td align="center">
			<div id="botonD">
				<html:link styleClass="cancelarD" href="#" onclick="hide(['popupConfirmar']);ocultarModal();">Cancelar</html:link>
			</div>
		</td>
	</tr>
