                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td align="right">
                                            <smx:paginacion start="${controlProduccionForm.start}" range="${controlProduccionForm.range}" results="${controlProduccionForm.size}" styleClass="textoNegro10" campos="false" url="actualizarDespacho.do" requestAjax="'mensajes','listado'"/>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                            ...
                            <td>
                                <table border="0" cellspacing="0" cellpadding="1" width="100%">
                                    <tr class="tituloTablas"  align="left">
                                        ...
                                        <td rowspan="2" class="columna_contenido" width="12%" align="center"><a class="linkBlanco9" title="Ordenar por c&oacute;digo de pedido" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=0'});">No Pedido</a></td>
                                        <td rowspan="2" class="columna_contenido" width="7%" align="center"><a class="linkBlanco9" title="Ordenar por c&oacute;digo de reservaci&oacute;n" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=1'});">No Res.</a></td>
                                        <td rowspan="2" class="columna_contenido" width="25%" align="center"><a class="linkBlanco9" title="Ordenar por nombre del cliente" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=2'});">Contacto Empresa</a></td>
                                        <!--<td rowspan="2" class="columna_contenido" width="12%" align="center"><a class="linkBlanco9" title="ordenar por estado del pedido" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=3'});">Estado</a></td>-->
                                        <td colspan="3" class="fila_contenido columna_contenido" width="22%" align="center">Despacho</td>
                                        <td rowspan="2" class="columna_contenido" width="9%" align="center"><a class="linkBlanco9" title="Ordenar por porcentaje producido" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=7'});">% Despachado</a></td>
                                        <td rowspan="2" class="columna_contenido" width="10%" align="center"><a class="linkBlanco9" title="Ordenar por fecha de despacho" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=8'});">Primera Fecha Despacho</a></td>
                                    </tr>
                                    <tr class="tituloTablas"  align="left">
                                        <td class="columna_contenido" width="7%" align="center"><a class="linkBlanco9" title="Ordenar por cantidad total reservada" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=4'});">Total</a></td>
                                        <td class="columna_contenido" width="8%" align="center"><a class="linkBlanco9" title="Ordenar por cantidad producida" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=5'});">Despachada</a></td>
                                        <td class="columna_contenido" width="7%" align="center"><a class="linkBlanco9" title="Ordenar por cantidad pendiente" href="#" onclick="requestAjax('actualizarDespacho.do',['ordenarPor','div_listado'],{parameters: 'indiceOrdenarP=6'});">Pendiente</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="1" width="100%">
                                        <logic:iterate name="controlProduccionForm" property="datos" id="vistaPedidoDTO" indexId="indicePedido">
                                            ...
                                            <tr class="${clase}">
                                                ...
                                                <td class="columna_contenido fila_contenido" width="25%" align="left"><bean:write name="vistaPedidoDTO" property="contactoEmpresa"/></td>
                                                ...
                                                <td class="columna_contenido fila_contenido columna_contenido_der" width="10%" align="center" title="Primera fecha de despacho al local"><bean:write name="vistaPedidoDTO" property="primeraFechaDespacho" formatKey="formatos.fecha"/></td>					    
                                            </tr>
                                        </logic:iterate>
                                    </table>
                                </div>
