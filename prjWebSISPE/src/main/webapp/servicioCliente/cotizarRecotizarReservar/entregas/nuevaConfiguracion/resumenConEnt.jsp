									...
									<tr>
										...
										<td align="right" width="105px">
											<div id="botonD">
												...
												<c:if test="${detallesConfigurados == totalDetalles}">
													<html:link title="Configuración de entregas" styleClass="aceptarD" href="#" onclick="requestAjax('entregaLocalCalendario.do', ['pregunta','entregas','mensajes','confirmarLocalEntrega','opcionesBusqueda','reserva','reservaCab','reservacion','datos','calendario','cambioMes','buscar','resumenEntregas'], {parameters: 'sinCambiosEnEntregas=ok',popWait:true, evalScripts:true});mostrarModalAux();">Config. Ent.</html:link>						
												</c:if>							
											</div>
										</td>
										<td align="right" width="105px">
											<div id="botonD">
												<html:link title="Elimina las entregas que se encuentren seleccionadas" styleClass="eliminarD" href="#" onclick="requestAjax('entregaLocalCalendario.do', ['mensajes','localEntrega','calendario','reserva','reservaCab','direccionEntregas','fechaEntregas','pregunta'], {parameters: 'botonEliminarEntrega=ok',popWait:true, evalScripts:true});">Eliminar Ent.</html:link>
											</div>
										</td>
										<%--td align="right" width="105px">
											<div id="botonD">
																...
																<td width="100%">
																	<table border="0" width="100%" align="center" cellspacing="0" cellpadding="0"  class="tabla_informacion" height="19px">
																		<tr>
																			...
																			<td width="70%" align="center" class="tituloTablas columna_contenido"><B>DIRECCI&Oacute;N</B></td>
																			<td width="30%" align="center" class="tituloTablas columna_contenido"><B>DISTANCIA ENTREGA&nbsp;(KM)</B></td>
																		...
																		<table border="0" cellspacing="0" cellpadding="0" align="left" width="100%" class="tabla_informacion">
																			<logic:iterate name="ec.com.smx.sic.sispe.pedido.direccionesAux" id="direccionesDTO" indexId="indiceDireccionEntregas">
																				...
																				<tr class="${color}">
																					...
																					<td width="70%" class="textoNegro9">&nbsp;<bean:write name="direccionesDTO" property="descripcion"/></td>
																					<td width="30%" align="center" class="textoNegro9">&nbsp;<bean:write name="direccionesDTO" property="distanciaDireccion"/></td>
																					<%--td width="20%" align="center" class="textoNegro9">&nbsp;<bean:write name="direccionesDTO" property="valorFlete" formatKey="formatos.numeros"/--%>
																					</td>
																				</tr>
																			</logic:iterate>
																		</table>
