                    ...
                    <table border="0" width="100%" cellpadding="0" cellspacing="0">
                        <logic:notEmpty name="ec.com.smx.sic.sispe.pedido.detallePedidoDTOCol">
                            <tr class="tituloTablas" align="left">
                                ...
                                <td class="columna_contenido" align="center" width="11%">Stock</td>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <logic:iterate name="ec.com.smx.sic.sispe.pedido.detallePedidoDTOCol" id="detalle" indexId="numDetalle">
                                                ...
                                                <tr class="${clase}">
                                                    ...
                                                    <td width="4%" class="columna_contenido fila_contenido" align="center">
                                                    ...
                                                    <logic:notEmpty name="detalle" property="codigoBarras">
                                                    	<td width="15%" class="columna_contenido fila_contenido" align="center">
                                                    		<bean:write name="detalle" property="codigoBarras"/>
                                                    	</td>
                                                    </logic:notEmpty>                                                    
                                                    ...
                                                    <td width="30%" class="columna_contenido fila_contenido" align="left">
                                                    	<!--<bean:write name="articulo" property="descripcionArticulo"/> stock aqui-->
                                                    </td>
                                                    
                                                    <td width="7%" class="columna_contenido fila_contenido" align="center">
                                                        <smx:text property="cantidadArticulo" value="${detalle.estadoDetallePedidoDTO.cantidadEstado}" styleClass="textNormal" size="6" maxlength="5" onkeypress=""/>	
                                                    </td>
                                                    <td width="7%" class="columna_contenido fila_contenido" align="center">
                                                        <smx:text property="pesoArticulo" value="${detalle.estadoDetallePedidoDTO.pesoArticuloEstado}" styleClass="textNormal" size="6" maxlength="5" onkeypress=""/>	
                                                    </td>
                                                    ...
                                                    <td width="33%" class="columna_contenido fila_contenido" align="right">
                                                        <html:textarea property="observacion" styleClass="textObligatorio" rows="2" cols="40" value="${detalle.estadoDetallePedidoDTO.observacionArticulo}"/>
                                                    </td>
                                                </tr>        
                                            </logic:iterate>
                                        </table>
                                ...
                                <table cellpadding="0" cellspacing="0" width="98%" align="left">
                                    <tr>
                                        <td align="center" width="3%">
                                        	<img src="images/flechader.gif" border="0">
                                        </td>
                                        
                                        <td align="right" width="30%">
                                            <label class="textoAzul11">&nbsp;&nbsp;C&oacute;digo barras:&nbsp;</label>
                                            <html:text property="codigoArticulo" size="17" styleClass="textNormal" onkeypress="return validarInputNumeric(event);" onkeydown="requestAjaxEnter('crearPedidoEspecial.do',['mensajes','detallePedido'],{parameters: 'agregarArticulo=ok',evalScripts:true});"/>
                                        </td>
                                        <td align="right" width="23%">
                                            <label class="textoAzul11">Cantidad/Peso KG:&nbsp;</label>
                                            <html:text property="cantidadArticuloI" size="6" maxlength="5" styleClass="textNormal" value="0" onkeypress="return validarInputNumericDecimal(event);" onkeydown="requestAjaxEnter('crearPedidoEspecial.do',['mensajes','detallePedido'],{parameters: 'agregarArticulo=ok',evalScripts:true});"/>
                                        </td>
