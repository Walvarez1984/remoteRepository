/*
 * ActualizarClasificacionUsuarioAction.java
...
/**
 * <p>
 * Permite controlar la actualizaci\u00F3n de una determinada configuraci\u00F3n de acceso a las clasificaciones 
...
public class ActualizarClasificacionUsuarioAction extends BaseAction
{
  /**
      ...
      HttpServletResponse response) throws Exception
  {
  	...
  	try{
	  	...
	  	//------------ cuando se desea elminar un usuario de las lista --------------
	  		...
	  		ClasificacionUsuarioAction.eliminarClasificacionUsuario(request, formulario.getChecksSeleccion(), "A");
	  	...
	  	//------------ cuando se desea agregar un listado de clasificaciones al listado -------------
